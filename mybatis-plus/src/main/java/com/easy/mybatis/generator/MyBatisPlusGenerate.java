package com.easy.mybatis.generator;
...
public class MyBatisPlusGenerate {
     ...
     * 作者
     */
    private static final String AUTHOR = "Tallon";

    /**
     * 工作目录
     */
    private static final String USER_DIR = System.getProperty("user.dir") + "/mybatis-plus";

    /**
     * JDBC 连接地址
     */
    private static final String JDBC_URL = "jdbc:mysql://mysql.tallon.com:3306/test?serverTimezone=Asia/Shanghai&useLegacyDatetimeCode=false&nullNamePatternMatchesAll=true&zeroDateTimeBehavior=CONVERT_TO_NULL&tinyInt1isBit=false&autoReconnect=true&useSSL=false&pinGlobalTxToPhysicalConnection=true";
     ...
     * 包配置 - 父级目录
     */
    private static final String PACKAGE_PARENT = "com.easy.mybatis";
     ...
     * 要生成的表，用 `,` 分割
     */
    private static final String TABLES = "tb_user,tb_admin";

    /**
     * 通用包路径
     */
    private static final String PACKAGE_BASE = "com.easy.mybatis.common.base";
    ...
    private static PackageConfig packageConfig() {
        ...
        // 设置模块的名字，比如 core，生成效果为 com.tallon.core
