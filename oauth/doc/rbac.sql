...
insert  into `tb_permission`(`id`,`parent_id`,`name`,`enname`,`url`,`description`,`create_time`,`update_time`) values 
...
insert  into `tb_role`(`id`,`parent_id`,`name`,`enname`,`description`,`create_time`,`update_time`) values 
...
insert  into `tb_user`(`id`,`username`,`password`,`phone`,`email`,`create_time`,`update_time`) values 
(37,'admin','$2a$10$9ZhDOBp.sRKat4l14ygu/.LscxrMUcDAfeVOEPiYwbcRkoB09gCmi','18888888888','tallon@qq.com','2020-11-20 23:21:27','2020-11-20 23:21:29');
